...
;       ----------------------------------------------------
        ...
        lda #%00000001          ; set PRG mode 1 - two 16k banks
        sta $5100

        lda #%00000001          ; set CHR mode 1 - 4KB CHR pages
        sta $5101

        lda #%01010000          ; set nametable mapping - horizontal mirroring
        sta $5105

        lda #%10000000          ; set PRG bank 1
        sta $5115

        lda #%11111111          ; set PRG ROM bank 3
        sta $5117

        lda #%0000000          ; set sprite CHR bank 3
        sta $5123

        lda #%00000011          ; set background CHR bank 3
        sta $512b

        lda #%00000000          ; set upper CHR bank bits
        sta $5130
...
palette:                        ; palette data
        ...
        .byte $0F,$13,$15,$17,$0F,$13,$15,$17,$0F,$13,$15,$17,$0F,$13,$15,$17 ; palette 7 - cyber rust
